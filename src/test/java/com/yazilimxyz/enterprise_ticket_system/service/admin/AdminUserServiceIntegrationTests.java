...
// import
// com.yazilimxyz.enterprise_ticket_system.dto.admin.AdminTicketResponseDto;
...
// Page<AdminTicketResponseDto> ticketsPage =
// adminUserService.getUserTickets(savedUser.getId(), 0, 10);
// assertEquals(3, ticketsPage.getTotalElements());
// assertTrue(ticketsPage.getContent().stream().anyMatch(t ->
// t.getId().equals(savedCreated.getId())));
// assertTrue(ticketsPage.getContent().stream().anyMatch(t ->
// t.getId().equals(savedAssignedOpen.getId())));
// assertTrue(ticketsPage.getContent().stream().anyMatch(t ->
// t.getId().equals(savedAssignedInProgress.getId())));
